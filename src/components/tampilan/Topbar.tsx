                ...
                <Link
                  ...
                  className={`group relative px-4 py-2 rounded-lg transition-all duration-200 ${
                    isScrolled 
                      ...
                      : 'text-white hover:text-red-200 hover:bg-red-700/50'
                  }`}
                >
              ...
              {userProfile ? (
                <DropdownMenu.Root>
                  <DropdownMenu.Trigger asChild>
                    <button className={`flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-200 outline-none ${
                      isScrolled 
                        ? 'bg-gray-100 hover:bg-gray-200 text-gray-900' 
                        : 'bg-red-600/50 hover:bg-red-600/80 text-white'
                    }`}>
                      ...
                      <span className="font-medium text-sm max-w-32 truncate">
                        {userProfile.profile?.full_name || userProfile.user.email}
                      </span>
                  ...
                  <DropdownMenu.Portal>
                    <DropdownMenu.Content className="mt-2 w-64 bg-white/95 backdrop-blur-md rounded-xl border border-gray-200/50 shadow-2xl p-2 z-[60] animate-in fade-in-0 zoom-in-95" sideOffset={5}>
                      ...
                      <DropdownMenu.Item asChild>
                        <Link href="/profile" className="flex items-center gap-3 w-full px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 outline-none cursor-pointer transition-colors">
                      ...
                      {userProfile.profile?.role === 'admin' && (
                        <DropdownMenu.Item asChild>
                          <Link href="/admin" className="flex items-center gap-3 w-full px-3 py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 outline-none cursor-pointer transition-colors">
                      ...
                      <DropdownMenu.Item onSelect={handleLogout} className="flex items-center gap-3 w-full px-3 py-2 text-sm text-red-600 rounded-lg hover:bg-red-50 hover:text-red-700 outline-none cursor-pointer transition-colors">
                ...
                <Link href="/login" className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
                  isScrolled 
                    ? 'bg-red-600 hover:bg-red-700 text-white shadow-md hover:shadow-lg' 
                    : 'bg-white text-red-700 hover:bg-red-50 shadow-md hover:shadow-lg'
                }`}>
                  Masuk
                </Link>
              )}
              ...
              {userProfile && (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center justify-between w-full px-3 py-2 text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition-colors"
                  >
