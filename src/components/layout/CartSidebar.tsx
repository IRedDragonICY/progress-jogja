...
export default function CartSidebar({ isOpen, onCloseAction }: CartSidebarProps) {
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => addToWishlist(item.products.id)}
                    className="p-2 text-gray-600 hover:text-red-600 hover:bg-red-100/80 rounded-md transition-colors backdrop-blur-sm"
                  >
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="space-y-2">
          <button
            ...
            className="w-full bg-red-600/90 backdrop-blur-sm text-white py-3 px-4 rounded-lg font-semibold hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2 shadow-sm"
          >
          ...
          <Link
            href="/produk"
            onClick={onCloseAction}
            className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-gray-100/80 text-gray-700 rounded-lg hover:bg-gray-200/80 transition-colors font-medium text-sm backdrop-blur-sm"
          >
            Lanjut Belanja
  ...
  return (
    <Sidebar
      ...
      title="Keranjang"
      icon={<ShoppingCartIcon className="w-6 h-6 text-red-500" />}
